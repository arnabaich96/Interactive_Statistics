...
Using the Central Limit Theorem, we can solve problems where we know the value and need to find the corresponding probability. Let's consider the context of test scores in a school. Suppose test scores are distributed with a mean of 500 and a standard deviation of 100.
...
#### **How do you calculate the Z-score in CLT applications?**  
...
#### **What is the role of the standard deviation in the CLT?**  
...
#### **How does the CLT help in solving probability problems?**
