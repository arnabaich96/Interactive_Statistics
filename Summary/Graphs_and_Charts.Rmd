...
fruit_data %>%
  ...
  row_spec(1:nrow(fruit_data), background = "lightblue")
...
kable_styling(full_width = FALSE, bootstrap_options = c("striped", "hover", "condensed")) %>%
  row_spec(0, bold = TRUE, color = "white", background = "#7C0A02") %>%
  row_spec(1:nrow(data_combined_pie), background = "lightblue")
...
kable_styling(full_width = FALSE, bootstrap_options = c("striped", "hover", "condensed")) %>%
  row_spec(0, bold = TRUE, color = "white", background = "#7C0A02") %>%
  row_spec(1:nrow(temperature_table), background = "lightblue")
