...
kable(biased_die_table_1, align = "c", row.names = FALSE,col.names = c("Value","Prob","Value*prob")) %>%
  kable_styling(full_width = FALSE, bootstrap_options = c("striped", "hover", "condensed")) %>%
  row_spec(0, bold = TRUE, color = "white", background = "#7C0A02") %>%
  row_spec(1:nrow(biased_die_table_1), background = "#f9e79f")
...
# Proper LaTeX expressions for headers
colnames(biased_die_table_2) <- c(
  "Die Face (X)", 
  "P(X = x)", 
  "(X - E(X))^2", 
  "$(X - E(X))^2 * P(X = x)$"
...
kable(biased_die_table_2, align = "c", row.names = FALSE, escape = FALSE) %>%
  kable_styling(full_width = FALSE, bootstrap_options = c("striped", "hover", "condensed")) %>%
  row_spec(0, bold = TRUE, color = "white", background = "#7C0A02") %>%
  row_spec(1:nrow(biased_die_table_2), background = "#f9e79f")
